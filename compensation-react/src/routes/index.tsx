  ...
  [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'payroll/batches/:batchId/ledger',
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PayrollBatchLedgerPage />
            </Suspense>,
          ),
        },
        {
          path: 'payroll/batches/:batchId/manager-review',
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PayrollManagerReviewPage />
            </Suspense>,
          ),
        },
        {
          ...
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PayrollConfirmationsPage />
            </Suspense>,
          ),
        },
        {
          path: 'payroll/distributions',
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PayrollDistributionsPage />
            </Suspense>,
          ),
        },
        {
          path: 'payroll/reconciliations',
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PayrollReconciliationsPage />
            </Suspense>,
          ),
        },
        {
          path: 'payroll/pt-readonly',
          element: withGuard(
            <Suspense fallback={<Loading />}>
              <PartTimeReadonlyPage />
            </Suspense>,
          ),
        },
