...
WHERE deleted = 0
  AND status <> 'disabled'
  AND code IN ('view.payroll.batches', 'view.payroll.cycles', 'view.payroll.templates', 'menu.payroll.import', 'menu.payroll.reports', 'business');
...
JOIN (
    ...
    WHERE ur.deleted = 0
      AND r.code IN ('view.payroll.batches', 'view.payroll.cycles', 'view.payroll.templates', 'menu.payroll.import', 'menu.payroll.reports', 'business')
    UNION
    SELECT DISTINCT ur.user_id
