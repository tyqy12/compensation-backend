...
VALUES
('API','api.payroll.confirmations.pending','待确认列表','/api/payroll/confirmations/pending',NULL,NULL,@menu_payroll_id,210,JSON_OBJECT('method','GET'),'enabled',@now,@now),
('API','api.payroll.confirmations.summary','确认汇总','/api/payroll/confirmations/batches/*/summary',NULL,NULL,@menu_payroll_id,211,JSON_OBJECT('method','GET'),'enabled',@now,@now),
...
('API','api.payroll.confirmations.assign','分配确认负责人','/api/payroll/confirmations/batches/*/assign',NULL,NULL,@menu_payroll_id,215,JSON_OBJECT('method','POST'),'enabled',@now,@now)
