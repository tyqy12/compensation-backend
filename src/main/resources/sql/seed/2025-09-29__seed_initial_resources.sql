...
('API','api.admin.app-registry.data-grants.list','开放应用-数据范围列表','/api/admin/app-registry/{id}/data-grants',NULL,NULL,(SELECT id FROM sys_resource WHERE code='admin' LIMIT 1),156,JSON_OBJECT('method','GET','roles',JSON_ARRAY('ADMIN')),'enabled',@now,@now),
('API','api.admin.app-registry.data-grants.create','开放应用-授权数据范围','/api/admin/app-registry/{id}/data-grants',NULL,NULL,(SELECT id FROM sys_resource WHERE code='admin' LIMIT 1),157,JSON_OBJECT('method','POST','roles',JSON_ARRAY('ADMIN')),'enabled',@now,@now),
('API','api.admin.app-registry.data-grants.revoke','开放应用-撤销数据范围','/api/admin/app-registry/{id}/data-grants/{grantId}',NULL,NULL,(SELECT id FROM sys_resource WHERE code='admin' LIMIT 1),158,JSON_OBJECT('method','DELETE','roles',JSON_ARRAY('ADMIN')),'enabled',@now,@now),
...
('API','api.admin.users.provision-from-employees','系统管理-按员工回填账号','/api/admin/users/provision-from-employees',NULL,NULL,COALESCE((SELECT id FROM sys_resource WHERE code='admin.auth-center' LIMIT 1),(SELECT id FROM sys_resource WHERE code='admin.users' LIMIT 1),(SELECT id FROM sys_resource WHERE code='admin' LIMIT 1)),165,JSON_OBJECT('method','POST','roles',JSON_ARRAY('ADMIN')),'enabled',@now,@now),
